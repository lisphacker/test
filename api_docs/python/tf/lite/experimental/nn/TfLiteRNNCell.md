...
<meta itemprop="name" content="tf.lite.experimental.nn.TfLiteRNNCell" />
...
* <b>`inputs_shape`</b>: Rnn input tensor shape.


#### Raises:

* <b>`ValueError`</b>: If last dimension of the input shape is not known.
