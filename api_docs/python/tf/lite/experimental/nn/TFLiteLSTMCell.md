...
<meta itemprop="name" content="tf.lite.experimental.nn.TFLiteLSTMCell" />
...
* <b>`inputs_shape`</b>: The inputs_shape must be known, and is [batch_size,
    input_size] shape.


#### Raises:

* <b>`ValueError`</b>: if the inputs_shape is invalid.
